...
export default {
  ...
  Query: {
    me: requiresAuth.createResolver(async (parent, args, { models, user }) => models.User.findOne({ where: { id: user.id } })),
    getUser: requiresAuth.createResolver(async (parent, args, { models, user }) => models.User.findOne({ where: { id: args.userId } })),
